...
# to find your TAB_TO_CHANGE_ORDER_OF take a look of the output of the current_page variable with the following line inside the blueprintConfig key
# print(current_page['page']['widgets'][0]['groups'][0]['widgets'][1]['groups'][0]['widgets'][0])
TAB_TO_CHANGE_ORDER_OF = 'Cluster$upstream'
...
# Change the tab index by the priority you want
current_page['widgets'][0]['groups'][0]['widgets'][1]['groups'][0]['widgets'][0]['blueprintConfig'][TAB_TO_CHANGE_ORDER_OF]['tabIndex'] = 0
